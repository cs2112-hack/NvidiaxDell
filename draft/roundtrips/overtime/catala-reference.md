...
## Declarations
    ...
    declaration scope WidgetPrice:
      input quantity content integer
      input unit_price content money
      internal band content decimal
...
scope under test with literal values and asserts:
    ...
    #[test]
    declaration scope TestWidgetPrice_Bulk:
      output r content WidgetPrice

    scope TestWidgetPrice_Bulk:
      definition r equals
        output of WidgetPrice with {
          -- quantity: 120
          -- unit_price: $2.50
        }
      assertion r.total = $270.00
