...
SCENARIOS: list[dict] = [
    ...
    {"name": "ask-no-coverage", "hash": "ask",
     "steps": [["fill", "#askfield", "What is the capital of France?"], ["submit", "#askform"], ["wait", ".turn .model-answer"],
               ["check", "no coverage, general answer"]]},
    {"name": "ask-general-failed", "hash": "ask",
     "api": {"POST /api/ask": (200, {"question": "What is the capital of France?", "engines": ["NONE", "MODEL"], "parts": [
         {"engine": "NONE", "kind": "no-coverage", "citations": [], "scope": None, "outputs": None, "inputs": None, "score": None, "model": None,
          "text": "No rule and no clause in your documents matched this closely enough to compute or quote an answer. It was passed "
                  "to the local model (qwen3.6:27b-q4_K_M), which did not answer."},
         {"engine": "MODEL", "kind": "general-failed", "citations": [], "scope": None, "outputs": None, "inputs": None, "score": None,
          "model": "qwen3.6:27b-q4_K_M", "read": ["NDA-MUT N-9.1", "EXP-POL E-1.1"],
          "text": "No answer from qwen3.6:27b-q4_K_M: it is probably busy with another job"}]})},
     "steps": [["fill", "#askfield", "What is the capital of France?"], ["submit", "#askform"], ["wait", ".turn .notice.is-warn", "busy"],
               ["check", "general answer failed"]]},
